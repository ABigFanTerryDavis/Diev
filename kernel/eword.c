...
static const char *ew_words[EW_MAXW] = {
    ...
    "ls", "cat", "rm", "ver", "kb",
    "beep", "mem", "iso", "wc", "cp",
    "crash", "shell", "kernel", "boot", "mouse",
    "window", "cursor", "file", "folder", "disk",
    "ram", "cpu", "error", "panic", "driver",
    "interrupt", "timer", "keyboard", "screen", "text",
    "color", "prompt", "command", "program", "binary",
    "code", "bug", "fix", "version", "update",
    "save", "load", "open", "close", "delete",
    "copy", "move", "rename", "list", "print",
    "apple", "book", "car", "dog", "house",
    "tree", "water", "fire", "earth", "air",
    "sun", "moon", "star", "night", "day",
    "morning", "evening", "today", "tomorrow", "yesterday",
    "food", "drink", "bread", "cheese", "coffee",
    "tea", "music", "song", "game", "play",
    "work", "school", "teacher", "friend", "family",
    "love", "happy", "sad", "big", "small",
    "fast", "slow", "new", "old", "hot",
    "cold", "light", "dark", "red", "blue",
    "green", "yellow", "black", "white", "one",
    "two", "three", "first", "last", "never",
    "always", "now", "here", "there", "up",
    "down", "left", "right", "in", "out",
    "on", "off", "yes", "no", "ok",
    "hi", "bye", "thanks", "please", "sorry",
    "good", "bad", "long", "short", "high",
    "low", "full", "empty", "true", "false",
    "over", "under", "again", "still", "yet",
    "very", "just", "only", "also", "well",
};
